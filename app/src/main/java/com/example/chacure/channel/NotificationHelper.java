package com.example.chacure.channel;
...
public class NotificationHelper extends ContextWrapper {
    ...
    private static final String CHANNEL_ID = "com.example.chacure";
    private static final String CHANNEL_NAME = "Chacure";
    ...
    public NotificationCompat.Builder getNotification(String title, String body){
        return new NotificationCompat.Builder(
                ...
                .setAutoCancel(true)
                .setColor(Color.GRAY)
                .setSmallIcon(R.drawable.chacurelogo)
    ...
    public NotificationCompat.Builder getNotificationMessage(Message[] messages, String usernameSender,
        ...
        return new NotificationCompat.Builder(getApplicationContext(), CHANNEL_ID)
                .setSmallIcon(R.mipmap.ic_chacure_logo)
